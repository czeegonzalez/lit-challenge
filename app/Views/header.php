...
<html lang="en">
  <head>
    ...
    <link href="<?php echo base_url('css/style.css'); ?>" rel="stylesheet" crossorigin="anonymous">
        ...
        <div class="px-3 py-2 border-bottom">
          <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
              <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 ms-auto navMenu1">
                <li>
        ...
        <div class="px-3 py-2  mb-3">
            <div class="container">
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                  ...
                  <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 navMenu2">
                    <li>
                      <a href="#" class="nav-link ">
                        Dashboard
                      </a>
